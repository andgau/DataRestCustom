...
//		Page<HotelSummary> hotels = this.repository.findByCity(city.getName(), new PageRequest(0,
//				10, Direction.ASC, "name"));
//		Hotel hotel = this.repository.findByCityAndName(city.getName(), hotels.getContent().get(0)
//				.getName());
